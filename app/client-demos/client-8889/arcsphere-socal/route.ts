...
const HOMEPAGE_SIDE_HERO_SOURCES = [
  ['https://framerusercontent.com/images/JEOoI9AUjiorAUapWVh1gnkvdBI.png', '/client-8889/homepage-hero-side-left-japanese.webp'],
  ['https://framerusercontent.com/images/eJtReq8aEIEdVjdWqNPxJAANXJQ.jpg', '/client-8889/homepage-hero-side-right-mediterranean.webp'],
] as const
...
(() => {
  const specs = [
    { needle: 'JEOoI9AUjiorAUapWVh1gnkvdBI.png', path: '/client-8889/homepage-hero-side-left-japanese.webp' },
    { needle: 'eJtReq8aEIEdVjdWqNPxJAANXJQ.jpg', path: '/client-8889/homepage-hero-side-right-mediterranean.webp' },
  ];
  const selector = 'header[data-framer-name="hero-section"] img';
