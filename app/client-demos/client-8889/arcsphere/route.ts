...
const REPLACEMENTS: Array<[RegExp, string]> = [
  ...
  [/We offer a complete range of architecture and interior design services tailored to create spaces\.?/gi, 'We offer a complete range of architecture and design services for residential and commercial projects, from initial planning through permit approval.'],
...
(() => {
  const pairs = [
    ...
    ['We offer a complete range of architecture and interior design services tailored to create spaces.', 'We offer a complete range of architecture and design services for residential and commercial projects, from initial planning through permit approval.'],
