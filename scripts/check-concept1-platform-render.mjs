...
requireText('#main [style*="opacity:0"]', 'failsafe must target Framer wrappers stuck at opacity:0')
requireText('opacity: 1 !important;', 'failsafe must force stuck Framer wrappers visible')
requireText('#main [style*="opacity:0.001"]', 'failsafe must target Framer appear-animation children')
requireText('transform: none !important; filter: none !important;', 'failsafe must clear Framer appear transforms and filters')
