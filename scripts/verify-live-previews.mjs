...
const selectedRequirements = [
  ...
  ['selected NGUYEN warms live preview before activation', /setWarmNguyenPreview\(true\)[\s\S]*rootMargin: '1200px 0px 1200px 0px'[\s\S]*selectedAutoplay=1[\s\S]*onLoad=\{\(\) => \{[\s\S]*nguyenWarmDoneRef\.current = true[\s\S]*setWarmNguyenPreview\(false\)[\s\S]*\}\}/],
