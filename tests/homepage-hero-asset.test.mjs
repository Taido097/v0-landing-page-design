...
const leftSidePath = new URL(
  '../public/client-8889/homepage-hero-side-left-japanese.webp',
  import.meta.url,
)
const rightSidePath = new URL(
  '../public/client-8889/homepage-hero-side-right-mediterranean.webp',
  import.meta.url,
)
...
test('selected side images replace only the original left and right Framer sources', () => {
  ...
  assert.match(routeSource, /'\/client-8889\/homepage-hero-side-left-japanese\.webp'/)
  assert.match(routeSource, /'\/client-8889\/homepage-hero-side-right-mediterranean\.webp'/)
